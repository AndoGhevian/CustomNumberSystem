...
//  */
// export class NSNumberaaa<T extends string[] | IDigitsConfig> {
//     /**
//      * _NumberSystem_ instance in which represented current number.
//      */
//     readonly ns: NumberSystemaaaaaaa<T> = null as any
//     /**
...
//      * **Default _false_**
//      */
//     constructor(ns: NumberSystemaaaaaaa<T>, number?: number, validate?: boolean)
//     constructor(ns: NumberSystemaaaaaaa<T>, numberStr?: string, validate?: boolean)
//     constructor(ns: NumberSystemaaaaaaa<T>, nsNumber: NSNumberaaa<any>, validate?: boolean)
//     constructor(ns: NumberSystemaaaaaaa<T>, decimalDigArray?: number[], validate?: boolean)
//     constructor(ns: NumberSystemaaaaaaa<T>, number?: any, validate?: boolean) {
...
//             case 'object':
//             default:
//                 if (number instanceof NSNumberaaa) {
...
//                     const numStr = NumberSystemaaaaaaa.powersArrToDecimal(number, this.ns.base, false)
...
//      * 
//      * @param nsNumber1 - NSNumberaaa.
//      * @param nsNumber2 - NSNumberaaa.
//      * @param validate - Defines if to validate arguments.
//      * 
//      * **Default - _false_**
//      */
//     static lessThan(nsNumber1: NSNumberaaa<any>, nsNumber2: NSNumberaaa<any>, validate?: boolean) {
...
//      * **Default - _false_**
//      */
//     static lessThanOrEqual(nsNumber1: NSNumberaaa<any>, nsNumber2: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber1, nsNumber2, validate }, compareOpSchema)
//         nsNumber1 = validArgs.nsNumber1
//         nsNumber2 = validArgs.nsNumber2
...
//      * **Default - _false_**
//      */
//     static equal(nsNumber1: NSNumberaaa<any>, nsNumber2: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber1, nsNumber2, validate }, compareOpSchema)
//         nsNumber1 = validArgs.nsNumber1
//         nsNumber2 = validArgs.nsNumber2
...
//         while (!JSBI.equal(divideNumber, NumberSystemaaaaaaa['ZERO_BIG_INT'])) {
//             digitsCount++
...
//      * **Default - _false_**
//      */
//     add(nsNumber: NSNumberaaa<any>, validate?: boolean) {
...
//      * **Default - _false_**
//      */
//     subtract(nsNumber: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber, validate }, opSchema)
//         nsNumber = validArgs.nsNumber

//         const sys = this.ns
//         const subtraction = JSBI.subtract(this.bigInt, nsNumber.bigInt)
//         if (JSBI.lessThan(subtraction, NumberSystemaaaaaaa['ZERO_BIG_INT'])) {
//             return null
//         }
...
//      * **Default - _false_**
//      */
//     remainder(nsNumber: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber, validate }, opSchema)
//         nsNumber = validArgs.nsNumber
...
//      * **Default - _false_**
//      */
//     multiply(nsNumber: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber, validate }, opSchema)
//         nsNumber = validArgs.nsNumber
...
//      * **Default - _false_**
//      */
//     divide(nsNumber: NSNumberaaa<any>, validate?: boolean) {
//         const validArgs = validateArguments({ nsNumber, validate }, opSchema)
//         nsNumber = validArgs.nsNumber
...
//      * **Default - _false_**
//      */
//     toSystem(ns: NumberSystemaaaaaaa<T>, validate?: boolean): NSNumberaaa<T> {
...
// import { NumberSystemaaaaaaa } from "../NumberSystem"
